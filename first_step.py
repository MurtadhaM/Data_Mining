...
Original file is located at
    https://colab.research.google.com/drive/1QIpr5KA0BrliqmQVoH3Z97UfWjcnZGof
"""

!pip install twint
!pip3 install --user --upgrade git+https://github.com/twintproject/twint.git@origin/master#egg=twint

!twint -u noneprivacy --csv --output data/none.csv --lang en --translate --translate-dest it --limit 10
